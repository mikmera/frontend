...
export const PrivacyPolicy: React.FC = wrapError(() => {
	...
	return (
		...
		>
			<Typography variant="h4" sx={{ mt: 10, textAlign: 'center' }} fontFamily={'ONE-Mobile-POP'}>
				개인정보 처리방침
			</Typography>
			<Typography variant="subtitle1" mt={10}>
				{`<${name}>('${address}')`}은 「개인정보보호법」 및 「정보통신망 이용 촉진 및 정보보호 등에
				관한 법률」 등 관련 법규에 의해 이용자의 개인정보를 보호하고 이와 관련한 고충을 신속하고
				원활하게 처리할 수 있도록 다음과 같은 개인정보 처리방침을 수립하여 공개합니다.
			</Typography>
			<Typography variant="subtitle1" mt={3} fontSize={20} fontWeight={700}>
				1. 개인정보의 처리 목적 및 수집 항목
			</Typography>
			<Typography variant="subtitle1">
				① {name}은 다음의 목적을 위하여 최소한의 개인정보만을 수집 및 처리하고 있으며, 다음의 목적
				이외의 용도로는 이용하지 않습니다.
			</Typography>
			<Typography variant="subtitle1">[서비스 이용시]</Typography>
			<Typography variant="subtitle1">- IP주소, 쿠키, 방문 일시, 서비스 이용 기록</Typography>
			...
			<Typography variant="subtitle1">
				① {name}은 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유·이용기간 또는 법령에
			...
			<Typography variant="subtitle1">
				① 정보주체는 {name}에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수
				있습니다.
			</Typography>
			<Typography variant="subtitle1">
				1. 개인정보 열람요구
			...
			<Typography variant="subtitle1" mt={3}>
				...
				<br />
				2. 법령에 근거하여 정보주체의 개인정보를 제공하거나 법령의 규정에 의하여 제공하는 경우
			</Typography>
			<Typography variant="subtitle1" mt={3} fontSize={20} fontWeight={700}>
				5. 개인정보의 파기
			</Typography>
			<Typography variant="subtitle1">
				① {name}은 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체 없이 해당 개인정보를
				파기합니다.
				<br /> 파기의 절차, 기한 및 방법은 다음과 같습니다.
			</Typography>
			<Typography variant="subtitle1">- 파기절차</Typography>
			<Typography variant="subtitle1">
				1. 이용자가 입력한 정보는 목적 달성 후 별도의 DB에 옮겨져 내부 방침 및 기타 관련 법령에 따라
				일정기간 저장된 후 혹은 즉시 파기됩니다. 이 때, DB로 옮겨진 개인정보는 법률에 의한 경우가
				아니고서는 다른 목적으로 이용되지 않습니다.
			</Typography>
			<Typography variant="subtitle1">- 파기기한</Typography>
			<Typography variant="subtitle1">
				1. {name}은 개인정보의 처리목적 달성, 해당 서비스의 폐지, 사업의 종료 등 그 개인정보가
				불필요하게 되었을 때에는 지체 없이 해당 개인정보를 파기합니다.
				<br />
				2. {name}은 개인정보 보유기간이 경과된 경우에는 보유 기간의 종료일로부터 5일 이내에, 그
				개인정보가 불필요하게 되었을 때에는 개인정보의 처리가 불필요한 것으로 인정되는 날로부터 5일
				이내에 그 개인정보를 파기합니다.
				<br />* 단, 관련 법령에 따라 개인정보를 보관하여야 하는 경우에는 해당 기간 동안 보관합니다.
			</Typography>
			<Typography variant="subtitle1" mt={3} fontSize={20} fontWeight={700}>
				6. 개인정보의 안전성 확보 조치
			</Typography>
			<Typography variant="subtitle1">
				{name}은 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
			</Typography>
			<Typography variant="subtitle1">1. 정기적인 자체 감사 실시</Typography>
			<Typography variant="subtitle1">2. 개인정보의 암호화</Typography>
			<Typography variant="subtitle1">3. 해킹 등에 대비한 기술적 대책</Typography>
			<Typography variant="subtitle1">4. 개인정보에 대한 접근 제한</Typography>
			<Typography variant="subtitle1">5. 비인가자에 대한 출입 통제</Typography>
			<Typography variant="subtitle1">6. 접속기록의 보관 및 위변조 방지</Typography>
			<Typography variant="subtitle1" mt={3} fontSize={20} fontWeight={700}>
				7. 개인정보 보호책임자
			</Typography>
			<Typography variant="subtitle1">
				{name}은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의
			...
			<Typography variant="subtitle1">
				① 정보주체는 개인정보침해에 대한 구제를 받기 위하여 아래의 기관에 문의하실 수 있습니다.
			</Typography>
			...
			<Typography variant="subtitle1" mb={20}>
				② 정보주체가 개인정보침해에 대한 구제를 요구할 경우에는 개인정보보호법 제76조에 따라
				개인정보분쟁조정위원회, 한국인터넷진흥원 개인정보침해신고센터 등에 분쟁해결을 신청할 수
				있습니다.
			</Typography>
		</Box>
	)
